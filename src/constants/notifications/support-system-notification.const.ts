 ...
 * that can trigger a support system notification.
 *
 ...
 */
export enum SUPPORT_SYSTEM_NOTIFICATION_TYPE {
...
export type SupportSystemNotificationType = `${SUPPORT_SYSTEM_NOTIFICATION_TYPE}`;
 ...
 */
export enum SUPPORT_SYSTEM_NOTIFICATION_PRIORITY {
...
export type SupportSystemNotificationPriority = `${SUPPORT_SYSTEM_NOTIFICATION_PRIORITY}`;