              ...
              >
                <AccordionTrigger className="px-5 py-4 hover:no-underline [&>svg]:hidden group">
                  <div className="flex items-center gap-3 w-full">
                    <div className={`${NEU_ICON_WELL} group-hover: transition-all duration-200`}>
                              ...
                              >
                                {destDraft.toAdd.map((f, i) => (
                                  <motion.div
                                    ...
                                    layout
                                    className="relative aspect-square rounded-xl overflow-hidden  border-2 border-[#006666]/20 group"
                                  >
