...
const NEU_INPUT = 'w-full rounded-xl bg-[#E7E5E4] text-[#1E2938] placeholder:text-[#1E2938]/40 font-[family-name:var(--font-jetbrains-mono)] text-sm shadow-[inset_3px_3px_7px_#c8c6c5,inset_-3px_-3px_7px_#ffffff] border-none focus:outline-none focus:ring-2 focus:ring-[#FF2157]/40 transition-all duration-200 px-3 h-11';
const NEU_TEXTAREA = 'w-full rounded-xl bg-[#E7E5E4] text-[#1E2938] placeholder:text-[#1E2938]/40 font-[family-name:var(--font-jetbrains-mono)] text-sm shadow-[inset_3px_3px_7px_#c8c6c5,inset_-3px_-3px_7px_#ffffff] border-none focus:outline-none focus:ring-2 focus:ring-[#FF2157]/40 transition-all duration-200 px-3 py-2.5 resize-none';
const NEU_BTN_DANGER = 'w-full rounded-xl bg-[#FF2157] text-white font-[family-name:var(--font-space-mono)] font-bold tracking-wide shadow-[4px_4px_8px_#cc0033,-2px_-2px_6px_#ff6688] hover:shadow-[6px_6px_12px_#cc0033,-3px_-3px_8px_#ff6688] hover:bg-[#e0001e] active:shadow-[inset_3px_3px_6px_#cc0033,inset_-2px_-2px_4px_#ff6688] transition-all duration-200 h-12 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF2157]/50';
                            ...
                            <div className="pl-5 pr-5 pt-4 pb-5 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2.5">
                                        <div className="h-7 w-7 rounded-lg bg-[#FF2157]/10 flex items-center justify-center shadow-[inset_1px_1px_3px_#c8c6c5]">
