...
const neu = {
  ...
  cardInner: 'bg-[#E7E5E4] rounded-xl border border-[#c8c6c4]/50  hover: transition-all duration-300',
  iconBox: (color: string) =>
    `rounded-lg p-2  flex items-center justify-center ${color}`,
  badge: 'bg-[#E7E5E4] text-[#006666] text-xs px-3 py-1 rounded-lg  font-[Space_Mono] border border-[#006666]/20',
