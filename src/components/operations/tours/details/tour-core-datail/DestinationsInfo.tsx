...
const NEU_CARD_HOVER = "hover:shadow-[10px_10px_20px_#c8c6c5,-10px_-10px_20px_#ffffff] hover:-translate-y-0.5 transition-all duration-300";
                                                    ...
                                                    >
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                            ...
                                                            {attraction.insiderTip && (
                                                                <div className="flex items-start gap-2 p-2.5 rounded-xl bg-[#FE9900]/5 border border-[#FE9900]/20 shadow-[inset_2px_2px_5px_#c8c6c5,inset_-2px_-2px_5px_#ffffff]">
                                                                ...
                                                                <div className="flex gap-2 overflow-x-auto pb-1">
                                                                    {attraction.imageIds.map((image, imgIdx) => (
                                                                        <motion.div
                                                                            ...
                                                                            className="relative w-20 h-20 rounded-xl shrink-0 overflow-hidden shadow-[3px_3px_6px_#c8c6c5,-3px_-3px_6px_#ffffff] hover:shadow-[4px_4px_8px_#c8c6c5,-4px_-4px_8px_#ffffff] transition-all group cursor-pointer"
                                                                        >
                                                                            <Image
                                                                                src={image.url}
                                                ...
                                                {destination.activities.map((activity, idx) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {activity.url && (
                                                                <a
                                                                    ...
                                                                    className="p-1.5 rounded-lg text-[#006666] shadow-[2px_2px_4px_#c8c6c5,-2px_-2px_4px_#ffffff] hover:shadow-[inset_2px_2px_4px_#c8c6c5,inset_-2px_-2px_4px_#ffffff] transition-all"
                                                                >
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                            ...
                                                            {activity.price && (
                                                                <div className="flex items-start gap-2 p-2.5 rounded-xl bg-[#00A63D]/5 border border-[#00A63D]/20 shadow-[inset_2px_2px_5px_#c8c6c5,inset_-2px_-2px_5px_#ffffff]">
