    ...
    return (
        <div className={`${NEU_CARD} p-1 overflow-hidden`}>
            ...
            <div className="p-6 space-y-6">
                        ...
                        >
                            ...
                            {tour.priceSummary.discountedAmount && (
                                <motion.div
                                    ...
                                    className="p-4 rounded-xl border border-[#FE9900]/20 bg-[#FE9900]/5  space-y-1"
                                >
                                    <div className="flex items-center gap-2">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                <div className={`h-3 w-full rounded-full ${NEU_SURFACE_INSET_SM}`}>
                                    <div
                                        className="h-full rounded-full bg-[#006666]  transition-all duration-700"
                ...
                >
                    {/* Upcoming */}
                    <div className={`${tour.isUpcoming ? "border border-[#006666]/20 bg-[#006666]/5" : "border border-[#1E2938]/10"} rounded-xl p-5  space-y-2`}>
                        <div className="flex items-center gap-2">
                            {tour.isUpcoming
                    ...
                    {/* Expired */}
                    <div className={`${tour.isExpired ? "border border-[#FF2157]/20 bg-[#FF2157]/5" : "border border-[#00A63D]/20 bg-[#00A63D]/5"} rounded-xl p-5  space-y-2`}>
                        <div className="flex items-center gap-2">
                            {tour.isExpired
                    ...
                    {/* Active Discount */}
                    <div className={`${tour.hasActiveDiscount ? "border border-[#FE9900]/20 bg-[#FE9900]/5" : "border border-[#1E2938]/10"} rounded-xl p-5  space-y-2`}>
                        <div className="flex items-center gap-2">
