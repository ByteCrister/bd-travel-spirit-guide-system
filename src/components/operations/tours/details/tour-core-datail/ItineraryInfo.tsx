                        ...
                        {tour.itinerary.map((day, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-[#006666] flex items-center justify-center shrink-0  z-10">
                                ...
                                <div className="flex-1 pb-2">
                                    <div className={`${NEU_CARD_SM} p-5 space-y-4 hover: hover:-translate-y-0.5 transition-all duration-300`}>
                                        {/* Day title row */}
                                        ...
                                        {day.importantNotes && day.importantNotes.length > 0 && (
                                            <motion.div
                                                ...
                                                className="p-4 rounded-xl border border-[#FE9900]/20 bg-[#FE9900]/5  space-y-2"
                                            >
