    ...
    >
        <div className="flex gap-4">
            ...
            <div className="w-12 shrink-0">
                <div className="h-12 w-12 rounded-full overflow-hidden bg-[#006666]/10 flex items-center justify-center text-[#006666] font-[family-name:var(--font-space-mono)] font-bold text-base shadow-[3px_3px_6px_#c8c6c5,-3px_-3px_6px_#ffffff]">
                    {review.user.avatar ? (
                    ...
                    <div className="mt-3 grid grid-cols-4 gap-2">
                        {review.images.slice(0, 8).map((img, i) => (
                            <button
                                ...
                                className="relative h-20 w-full rounded-xl overflow-hidden shadow-[3px_3px_6px_#c8c6c5,-3px_-3px_6px_#ffffff] focus:outline-none focus:ring-2 focus:ring-[#006666]/40"
                    ...
                    >
                        ...
                        <div className="max-w-[90%] max-h-[90%]">
                            <Image
                                ...
                                className="max-h-[90vh] rounded-2xl object-contain shadow-[16px_16px_32px_#000000/40]"
                            />
                        </div>
                    </motion.div>
                )}
