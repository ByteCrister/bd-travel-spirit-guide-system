        ...
        <div className="space-y-3" style={spaceMono.style}>
            ...
            <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="relative flex-1 min-w-[260px]">
                    <Search size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#1E2938]/35 pointer-events-none" />
                    <Input
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1.5 min-w-[180px]">
                                <label className="text-[10px] uppercase tracking-widest text-[#1E2938]/40 font-medium">Date range</label>
                                <Select
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-[#1E2938]/40 font-medium">From</label>
                                <Input
                                    type="date"
                            ...
                            {/* To date */}
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-[#1E2938]/40 font-medium">To</label>
                                <Input
                                    type="date"
                            ...
                            {/* Per page */}
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-[#1E2938]/40 font-medium">Per page</label>
                                <Select
                                    value={String(filters.limit ?? 20)}
                                    onValueChange={(val) => onFilterChange({ limit: Number(val) })}
                                >
                                    <SelectTrigger className={cn(neuSelect, 'h-9 text-sm w-[110px]')}>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent className="bg-[#E7E5E4] border-0 shadow-[6px_6px_16px_#c8c6c4,-4px_-4px_12px_#ffffff] rounded-xl text-[#1E2938]">
                                        {[10, 20, 50, 100].map((n) => (
                                            <SelectItem key={n} value={String(n)} style={jetbrainsMono.style}>{n} rows</SelectItem>
                                        ))}
                                    </SelectContent>
                                </Select>
                            </div>
