...
/** Log audit as the authenticated user (actorModel defaults to User). */
export async function logAuditForActor(
    actorId: string | Types.ObjectId,
    input: Omit<AuditLogInput, "actor" | "actorModel">
): Promise<void> {
...
export { AUDIT_ACTION, type AuditAction };
